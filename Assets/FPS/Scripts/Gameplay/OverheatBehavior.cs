...
namespace Unity.FPS.Gameplay
{
    public class OverheatBehavior : MonoBehaviour
    {
        ...
        void Awake()
        {
            // Collect renderers using the overheating material
        ...
        void Update()
        {
            // Update material emission color based on ammo ratio
            ...
            // Play cooling sound based on ammo ratio and cooling state
